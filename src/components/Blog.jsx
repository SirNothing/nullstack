...
const Blog = ({ blog, likeBlog, delBlog }) => {
  ...
  if( !info ) {
    return(
      <div style={blogStyle}>
        {blog.title} <button onClick={handleShow} placeholder='show' type='button' value='Show'> Show more.. </button>
      </div>
    )
  } else {
    return( <div className='hiddenText' style={blogStyle}>
      ...
      <button onClick={likeBlog(blog.id, blog)} placeholder='like' type='text' value='like'> like it </button> <br/>
