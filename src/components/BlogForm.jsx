...
const BlogForm = ({ createBlog }) => {
  ...
  return( <>
    ...
    <form onSubmit={handleSubmit}>
      ...
      <label> likes <input id='likes' placeholder='input_likes' type='text' value={likes} onChange={ (e) => setLikes(e.target.value) } /> </label>
      <button placeholder='form_submit' id='form_submit' type='submit'> add blog </button>
    </form>
